...
void main() {
  group('link', () {
    ...
    test('with_space', () {
      var ref =
          StorageFileRef('bucket.appspot.com', 'test/with space/file.jpg');
      expect(ref.bucket, 'bucket.appspot.com');
      expect(ref.path, 'test/with space/file.jpg');
      expect(
          ref.toString(), 'gs://bucket.appspot.com/test/with%20space/file.jpg');

      ref = StorageFileRef.fromLink(ref.toLink());
      expect(ref.bucket, 'bucket.appspot.com');
      expect(ref.path, 'test/with space/file.jpg');

      var uri = Uri.parse('gs://test.appspot.com')

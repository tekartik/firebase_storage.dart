...
void main() {
  ...
  group('storage_fs', () {
    ...
    run(firebase: firebase, provider: storageServiceProvider);

    var app = firebase.initializeApp();
    var service = storageServiceProvider.storageService(firebase);
    ...
    test('bucket_no_name', () async {
      ...
      expect(
          bucketIo.localPath, join(".dart_tool", "tekartik_firebase_local", "_default", "storage._default"));
    });
